    ...
    <div className="animate-in fade-in slide-in-from-top-4 space-y-8 duration-1000">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="space-y-3">
          ...
          <p className="font-sans text-lg font-medium text-slate-500">
            Tổng quan tình hình kinh doanh và phân tích doanh thu thời gian thực.
          </p>
        </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Legend 
                  ...
                  align="right" 
                  iconType="circle"
                  wrapperStyle={{ paddingBottom: '20px', fontWeight: 800, fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.05em' }}
                />
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3 px-2">
          ...
          <h2 className="font-display text-xl font-black tracking-tight text-slate-900">Chi tiết dữ liệu</h2>
        </div>
        ...
        <PremiumTable>
          <PremiumTableHeader>
            <PremiumTableRow>
              ...
              <PremiumTableHead className="text-right">Doanh thu (VND)</PremiumTableHead>
              <PremiumTableHead className="text-right">Số lượng đơn hàng</PremiumTableHead>
            </PremiumTableRow>
          </PremiumTableHeader>
          <tbody>
            {data.length > 0 ? (
              data.map((item) => (
                <PremiumTableRow key={item.date}>
                  ...
                  <PremiumTableCell className="text-right font-mono text-base font-black tracking-tighter text-emerald-600">
                    ...
                    <span className="ml-1 text-[10px] font-bold text-slate-400">đ</span>
                  </PremiumTableCell>
              ...
              <PremiumTableRow>
                <PremiumTableCell colSpan={3} className="py-20 text-center">
                   <div className="flex flex-col items-center justify-center opacity-40">
                    <LayoutDashboard size={40} className="mb-4 text-slate-300" />
                    <p className="font-bold text-slate-400">Không có dữ liệu trong khoảng thời gian đã chọn</p>
                  </div>
                </PremiumTableCell>
              </PremiumTableRow>
            )}
