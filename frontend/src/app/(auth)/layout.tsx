    ...
    <div className="relative isolate min-h-screen overflow-hidden bg-white">
      ...
      <div className="grid min-h-screen lg:grid-cols-2">
        ...
        <div className="relative hidden flex-col items-center justify-center p-12 lg:flex">
          <div className="relative z-10 max-w-lg space-y-8 text-center lg:text-left">
            ...
            <h1 className="font-display text-5xl font-black tracking-tight text-slate-900 sm:text-6xl">
              Chào mừng đến với{' '}
              <span className="text-gradient-primary">BKShop</span>
            </h1>

            <p className="font-sans text-xl leading-relaxed font-medium text-slate-500">
              Khám phá thế giới công nghệ và phong cách sống với những sản phẩm
              cao cấp được tuyển chọn kỹ lưỡng.
            </p>
        ...
        <div className="relative flex items-center justify-center p-6 lg:p-12">
          <div className="animate-in fade-in slide-in-from-bottom-8 w-full max-w-md duration-1000">
            {children}
          </div>
        </div>
      </div>
