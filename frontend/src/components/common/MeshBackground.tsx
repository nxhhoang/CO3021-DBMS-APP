...
export const MeshBackground = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'absolute -top-[10%] -left-[10%] h-[50%] w-[50%] rounded-full opacity-30 blur-[120px] transition-all duration-1000 animate-pulse',
      ...
      <div
        className={cn(
          'absolute top-[10%] -right-[10%] h-[40%] w-[40%] rounded-full opacity-20 blur-[100px] transition-all duration-1000 delay-300 animate-bounce',
      ...
      <div
        className={cn(
          'absolute -bottom-[10%] left-[20%] h-[30%] w-[60%] rounded-full opacity-25 blur-[110px] transition-all duration-1000 delay-700',
