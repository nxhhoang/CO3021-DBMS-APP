  ...
  return (
    <div
      className={cn(
        ...
        variant === 'outline' &&
          'rounded-full border border-slate-200 px-2.5 py-0.5 text-[10px] font-black tracking-widest uppercase',
        variant === 'dot' &&
          'bg-transparent px-0 text-[10px] font-black tracking-widest uppercase',
        className,
      )}
    >
      <span
      ...
      />
      <span className={variant === 'dot' ? 'text-slate-600' : ''}>
        {config.label}
      </span>
    </div>
  )
