      ...
      <Card className="glass-card">
        <div className="border-b border-white/40 px-6 py-4 dark:border-white/10">
          <div className="flex items-center gap-2">
             ...
             <h3 className="font-display text-xl font-bold tracking-tight text-slate-900 dark:text-white uppercase">
               Hóa đơn
             </h3>
          </div>
        </div>
          ...
          {hasItems ? (
            <div className="animate-in fade-in slide-in-from-bottom-2 space-y-6 duration-300">
              ...
              <div className="space-y-4 border-t border-white/40 pt-6 dark:border-white/10">
                <div className="flex items-center justify-between">
                  <span className="font-display text-[11px] font-bold tracking-wider text-slate-400 uppercase">Tạm tính</span>
