  ...
  return (
    ...
    >
      <input
        ...
        className="w-full rounded-2xl border border-slate-200 bg-slate-100/50 px-6 py-2.5 pl-14 text-sm transition-all duration-300 placeholder:text-slate-400 focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-500/10 focus:outline-none group-hover:border-slate-300 group-hover:bg-slate-100/80"
      />
