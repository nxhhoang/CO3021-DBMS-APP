...
\fancyfoot[L]{\scriptsize \ttfamily Assignment for Database Systems - Academic year 2025 - 2026}
...
\begin{center}
\begin{tabular}{c}
\multicolumn{1}{l}{\textbf{{\Large DATABASE SYSTEM (CO201B)}}}\\
~~\\
\hline
\\
\multicolumn{1}{l}{\textbf{{\Large Assignment}}}\\
\\
\textbf{\textit{{\LARGE “IN-MEMORY DATABASE SYSTEMS”}}}\\
\\
\hline
\end{tabular}
\end{center}
...
\centering
    ...
    & \\[10pt]
    \textbf{Students}: &  Nguyễn Xuân Huy Hoàng - 2311070 \\
    \end{tabular}
\end{table}
\vspace{4cm}
\begin{center}
...
\large
\input{content/1. Giới thiệu}
\input{content/2. Kiến trúc ứng dụng}
\input{content/3. So sánh và thực nghiệm}
\input{content/So sánh và thực nghiệm/3.1. Data Storage & Management}
\input{content/So sánh và thực nghiệm/3.2. Indexing}
\input{content/So sánh và thực nghiệm/3.3. Query Processing}
\input{content/So sánh và thực nghiệm/3.4. Transaction}
\input{content/So sánh và thực nghiệm/3.5. Concurrency Control}
\input{content/4. Demo ứng dụng}
