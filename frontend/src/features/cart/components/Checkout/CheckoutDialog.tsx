        ...
        <DialogContent className="max-h-[90vh] max-w-xl overflow-hidden border-none bg-white/95 p-0 shadow-2xl backdrop-blur-3xl flex flex-col sm:rounded-3xl dark:bg-slate-900/95">
          ...
          <div className="flex-1 overflow-y-auto space-y-8 p-6 sm:p-8">
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-6 dark:border-white/5 dark:bg-slate-800/50">
              <div className="mb-4 flex items-center gap-2 font-display text-[10px] font-bold tracking-[0.1em] text-slate-400 uppercase">
              ...
              {isAddressLoading ? (
                ...
                <div className="flex items-center gap-2 py-1 text-[11px] font-bold text-rose-500 uppercase tracking-widest">
            ...
            <div className="space-y-4">
               <div className="flex items-center gap-2">
                  ...
                  <p className="font-display text-[10px] font-bold tracking-wider text-slate-400 uppercase">Sản phẩm thanh toán</p>
               </div>
            ...
            <div className="flex items-center justify-between border-t border-slate-100 pt-6 dark:border-white/5">
              <p className="font-display text-[10px] font-bold tracking-wider text-slate-400 uppercase">Tổng thanh toán</p>
          ...
          <DialogFooter className="border-t border-slate-100 bg-slate-50/50 p-6 dark:border-white/10 dark:bg-slate-800/50 shrink-0">
            <div className="flex w-full flex-col gap-3 sm:flex-row sm:justify-end">
              <Button
                ...
                className="h-12 rounded-xl px-6 font-display text-[11px] font-bold tracking-wider text-slate-500 uppercase hover:bg-slate-100 dark:hover:bg-white/5"
              >
                Hủy bỏ
              </Button>
              <Button
                className="btn-premium-primary group relative h-12 min-w-[200px] overflow-hidden rounded-xl"
        ...
        <DialogContent className="max-w-md overflow-hidden border-none bg-white/95 p-0 shadow-2xl backdrop-blur-3xl sm:rounded-3xl dark:bg-slate-900/95">
          <div className="flex flex-col items-center p-8 text-center sm:p-10">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm font-medium leading-relaxed text-slate-500">
                Đơn hàng của bạn đã được chuyển tới bộ phận xử lý và sẽ sớm được giao tới địa chỉ của bạn.
              </p>
            </div>

            <div className="mt-6 flex flex-col items-center gap-2">
               <p className="font-display text-[9px] font-bold tracking-widest text-slate-400 uppercase">Mã đơn hàng</p>
          ...
          <DialogFooter className="bg-slate-50/50 p-6 dark:bg-slate-800/50">
            <div className="flex w-full flex-col gap-3 sm:flex-row sm:justify-center">
              <Button
                variant="outline"
                className="h-12 rounded-xl border-slate-200 px-6 font-display text-[10px] font-bold tracking-wider text-slate-600 uppercase hover:bg-white dark:border-white/10 dark:text-slate-400"
                onClick={handleCloseSuccess}
              >
                Tiếp tục
              </Button>
              <Button
                className="h-12 rounded-xl bg-slate-900 px-8 font-display text-[10px] font-bold tracking-wider text-white uppercase transition-all hover:scale-105 active:scale-95 dark:bg-white dark:text-slate-900"
                onClick={() => {
                  handleCloseSuccess()
