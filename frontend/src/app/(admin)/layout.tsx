    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50">
        <div className="space-y-4 text-center">
          ...
          <Link href="/" className="btn-premium-primary inline-block px-6 py-2">
            Quay lại trang chủ
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="relative isolate min-h-screen bg-slate-50/50">
      ...
      <aside className="fixed top-0 left-0 z-50 flex h-screen w-72 flex-col p-6 transition-all duration-500">
        <div className="glass-sidebar flex h-full flex-col border-none shadow-2xl ring-1 shadow-slate-200/50 ring-white/20">
          {/* LOGO SECTION */}
          <div className="mb-10 p-2">
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-0.5">
                <h1 className="font-display text-lg font-black tracking-tight text-slate-900">
                  BKShop
                </h1>
          ...
          {/* MENU SECTION */}
          <nav className="scrollbar-none flex-1 space-y-1.5 overflow-y-auto px-2">
